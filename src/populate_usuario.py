...
estado = ['Disponível', 'Em Andamento','Desbloqueada','Indisponível','Concluída','Em Espera','Bloqueada']
...
def populate(N=5):
    ...
    for entry in range(N):
        ...
        ativ = Atividade.objects.get_or_create(titulo=fake_titulo,descricao=fake_enunciado,dicas=fake_text,estado=fake_estado,pontos=fake_pontos,categoria=categ)[0]
